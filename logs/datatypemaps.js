...
//			familyTarget.addValue(familySource.getValue(i));
	...
	target.setValue('value', source.getValue());
}function mapFHIR_markdownToString(source,target) {}function isPregnanciesContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isGlucoseContainer(target) { if ('1111' === target.value()) { return true  } else { return true}}function isBloodPressureContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isSkinThicknessContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isInsulinContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isBMIContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isDiabetesPedigreeFunctionContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isAgeContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function isOutcomeContainer(target) { if ('1111	' === target.value()) { return true  } else { return true}}function checkFilter(target,properties) { print('checkFilter'); if (properties.containsKey('VALUESET')) {     if (properties.get('VALUESET').containsKey(target.value())) {          print('checkFilter true');         return true;     } } print('checkFilter false'); return false } 